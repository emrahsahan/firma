...
class Emlak(models.Model):
    ...
    oda = models.CharField(max_length=50, verbose_name='Oda Sayısı', null=True, blank=True)
    kat = models.CharField(max_length=50, verbose_name='Bulunduğu Kat', null=True, blank=True)
    ...
    isinmatipi = models.CharField(max_length=100, verbose_name='Isınma Tipi', null=True, blank=True)
